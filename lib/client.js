					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							...
							react_jsx_runtime.jsx("div", {
								...
								children: "为每个勾选的模式生成一个 <模式>-compact-<阈值> 预设，把 compaction-basic.thresholdRatio 统一改成下面这个值（DSH 默认 0.8）。改动对新建会话生效，正在运行的会话保持原样。"
							})
						]
					}),
					...
					react_jsx_runtime.jsxs("div", {
						...
						children: [
							react_jsx_runtime.jsxs("span", {
								...
								children: [status !== "" ? status : dirty ? "未保存的更改" : "", managed.length > 0 ? "　已生成：" + managed.join("、") : ""]
							}),
